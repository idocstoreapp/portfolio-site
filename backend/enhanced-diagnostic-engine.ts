...
/**
 * Genera el perfil de resultado básico según el tipo de negocio
 */
function getResultProfile(businessType: BusinessType): DiagnosticEnvelope['resultProfile'] {
  const profiles: Record<BusinessType, DiagnosticEnvelope['resultProfile']> = {
    'restaurante': {
