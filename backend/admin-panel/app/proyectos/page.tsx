...
export default function ProyectosPage() {
  const [proyectos, setProyectos] = useState<Diagnostic[]>([]);
  ...
  async function loadProyectos() {
    try {
      // Cargar solo proyectos aprobados (estado = 'proyecto' o 'cerrado')
    ...
    <AuthGuard>
      <div className="flex min-h-screen bg-gray-50">
        ...
        <div className="flex-1 ml-64">
          ...
          <main className="p-6">
            <div className="mb-6">
              <h1 className="text-3xl font-bold text-gray-900">Proyectos Activos</h1>
              <p className="text-gray-600 mt-2">
                Gestiona proyectos aprobados y registra costos reales
              </p>
            </div>
            ...
            {loading ? (
              ...
              <div className="bg-white rounded-lg shadow-md p-12 text-center">
                ...
                <Link
                  href="/diagnosticos?estado=nuevo"
